...
router.get('/categoria/:valor', async (req, res) => {
    ...
    try {
        ...
        if (id_categoria.length == 0) return handleError(res, 'No se pudo obtener la categoria ' + valor, null, 404);
        ...
        if (books.length == 0) return handleError(res, 'No hay libros con la categoria ' + valor, null, 404);
